...
public class TestGenerator {
    public static void main(String[] args) {
        ...
        DataSourceConfig dsc = new DataSourceConfig.Builder("jdbc:mysql://192.168.10.102:3306/shequ-acl?&useSSL=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai", "root", "123456")
        ...
        String filePath = projectPath + "/generate/src/main/java";  //java下的文件路径
        ...
        PackageConfig packages = new PackageConfig.Builder()
                .entity("entity")//实体类包名
                .parent("com.ojq")//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
                ...
                .pathInfo(Collections.singletonMap(OutputFile.mapperXml, projectPath + "/generate/src/main/resources/mapper")) //路径配置信息,就是配置各个文件模板的路径信息,这里以mapper.xml为例
                .build();
        /**
         * 模板配置
         */
