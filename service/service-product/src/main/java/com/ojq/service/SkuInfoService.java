...
public interface SkuInfoService extends IService<SkuInfo> {
    ...
    //sku列表
    IPage<SkuInfo> selectPageSkuInfo(Page<SkuInfo> pageParam, SkuInfoQueryDto skuInfoQueryDto);

    //添加商品sku信息
    void saveSkuInfo(SkuInfoDto skuInfoDto);

    //获取sku信息
    SkuInfoDto getSkuInfo(Long id);

    //修改sku
    void updateSkuInfo(SkuInfoDto skuInfoDto);
...
//    //根据skuId获取sku信息
//    SkuInfoDto getSkuInfoDto(Long skuId);
