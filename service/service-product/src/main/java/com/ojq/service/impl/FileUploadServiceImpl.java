...
import com.ojq.config.AliOSSConfig;
import com.ojq.service.FileUploadService;
...
//    private String bucketName;
    ...
    public String uploadFile(MultipartFile file) {
        ...
        OSS ossClient = new OSSClientBuilder()
                .build(aliOSSConfig.getEndpoint(), aliOSSConfig.getKeyId(), aliOSSConfig.getKeySecret());
        ...
        try {
            ...
            PutObjectRequest putObjectRequest =
                    new PutObjectRequest(aliOSSConfig.getBucketName(), objectName, inputStream);
